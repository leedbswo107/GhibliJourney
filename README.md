...
- 감독 드롭다운 메뉴로 감독별 작품을 찾아볼 수 있습니다.
...
- 작품 호버시 제목 및 로튼토마토 지수 출력  
  (+추가) 드롭다운 메뉴로 감독별 작품 출력

## :warning: 해결해야하는 부분

| 문제 영역                     | 문제 내용                                                                                                                                             | 해결                                                                                                                                                                            |
| ----------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| <img src="./img/issue1.png"/> | 포스터를 클릭하면 해당 포스터가 나타내는 영화의 상세정보를 modal에서 확인해야하는데 클릭 이벤트와 render 는 별도로 있기에 데이터를 따로 연결해야 함 | api에 id 를 dataset에 주어 포스터를 클릭하면 그 값을 전달해 디테일에 접근하게 해결                                                                                              |
